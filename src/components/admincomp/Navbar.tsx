...
const Navbar = () => {
    ...
    return (
        <div className='w-full flex flex-row gap-[20px] items-center bg-white px-4 py-4 justify-between'>
            <div className='hidden md:flex flex-row items-center p-2 bg-[#F9FAFB] rounded-[12px] px-4 py-3 gap-[10px]'>
            ...
            <div className='flex flex-row gap-[10px] items-center'>
                ...
                <div className='cursor-pointer rounded-full bg-[#F0F2F5] '>
                    {sessionData?.user ? (
                        <Image src={sessionData?.user?.image || '/default-profile.png'} alt='profile' width={45} height={45} className='rounded-full' />
                    ) : ""}
                </div>
            </div>
